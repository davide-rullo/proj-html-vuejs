...
<template>
    <footer>
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 footer-row">
            <div class="col p-2">
                    ...
                    <div class="tweet d-flex">
                        ...
                        <div class="tweet-text d-flex flex-column text-white">
                            ...
                            <p>Do you need sublime WordPress hosting for your next Website? Take advantage of exclusive
                                partner offers that we have secured just for you, & launch your site in seconds with <span
                                    class="highlight">#avada</span>
                                on WP Engine hosting & get 30% Off this Black Friday <span class="highlight"> bit.ly3kjlle2
                                    #BlackFriday2020</span></p>
                ...
                <div class="footer-menu d-flex flex-column cont">
                    ...
                    <div class="contact d-flex">
                        ...
                        <div class="d-flex flex-column">
                            <p class="m-0">Corporate Location</p>
                            <p class="m-0">1600 Amphitheatre Parkway</p>
                            <p class="m-0">London WC1 1BA</p>
                        </div>
                    </div>
                    <div class="contact d-flex">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                        ...
                        <div class="d-flex flex-column">
                            <p class="m-0">Residential Location</p>
                            <p class="m-0">9521 Broadsberry Avenue</p>
            ...
            <div class="col p-2">
                <div class="footer-menu">
                    <h6 class="menu-title">FIND US</h6>
                    <img src="../assets/img/find-us.png" alt="">
                </div>
            </div>
        </div>
        <div class="copy-bar d-flex justify-content-between align-items-center">
            <div class="copy">
                Copyright 2012-2015 avada theme by <span class="weight">theme fusion</span> | all right reserved | powered
                by <span class="weight">WordPress</span>
            </div>
            <div class="copy-social d-flex gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" height="1em"
