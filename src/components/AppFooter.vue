            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 footer-row">
                <div class="col p-2">
                    <div class="footer-menu">
                        ...
                        <p class="summary">We are specialists in the construction of unique and exclusive properties. Our
                            work
                            inspires. We
                            pride ourselves on delivering outstanding quality and design for leading clients across the
                            world.
                        </p>
