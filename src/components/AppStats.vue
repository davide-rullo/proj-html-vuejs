            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4">
                <div class="col p-2">
                    <div class="stats-card d-flex flex-column justify-content-center align-items-center">
                        ...
                        <h2 class="stats-num">3534</h2>
                        <p class="stats-name">planning application</p>
                    </div>
                </div>
                <div class="col p-2">
                    <div class="stats-card d-flex flex-column justify-content-center align-items-center">
                        ...
                        <h2 class="stats-num">896</h2>
                        <p class="stats-name">Completed projects</p>
                ...
                <div class="col p-2">
                    <div class="stats-card d-flex flex-column justify-content-center align-items-center">
                        ...
                        <h2 class="stats-num">172</h2>
                        <p class="stats-name">Trained professionals</p>
                ...
                <div class="col p-2">
                    <div class="stats-card d-flex flex-column justify-content-center align-items-center">
                        ...
                        <h2 class="stats-num">19</h2>
                        <p class="stats-name">International offices</p>
